          ...
          <Block space="between" style={styles.padded}>
            <Block>
              <Block >
                ...
                <Block row>
                  <Text color="white" size={60}>Stay Alerted</Text>
                  <Block middle style={styles.pro}>
                    <Text size={16} color="white">UchafuNiDili</Text>
                  </Block>
                </Block>
              </Block>
              <Text size={16} color='rgba(255,255,255,0.6)' style={{ marginTop: 35 }}>
                We are working on This and Many other features!!
              </Text>
              ...
              <Button
                ...
                <Text bold color={theme.COLORS.WHITE}>BACK</Text>
              </Button>
            </Block>
          </Block>
        </Block>
